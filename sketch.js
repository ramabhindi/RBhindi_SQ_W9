...
// ------------------------------------------------------------
// DEBUG PANEL
// showDebug controls whether the debug panel is visible.
// Toggled on/off with the D key.
// ------------------------------------------------------------
let showDebug = false;
...
// ------------------------------------------------------------
// drawDebugPanel()
// Draws a debug panel showing useful testing shortcuts.
// Only appears when showDebug is true.
// ------------------------------------------------------------
function drawDebugPanel() {

  // Don't draw anything if debug mode is off
  if (!showDebug) return;
  ...
  text("DEBUG PANEL", 20, 105);

  // Shortcut list
  text("D = Toggle Debug", 20, 130);
  text("1 = Jump to Level 1", 20, 150);
  text("2 = Jump to Level 2", 20, 170);
